var Sentry = function (t) {
    ...
    var z, V = B.__SENTRY__.logger || (B.__SENTRY__.logger = new J),
        K = function () {
            function t() {
    ...
    function nt(t, n) {
        return "domain" === n && t && "object" == typeof t && t.u ? "[Domain]" : "domainEmitter" === n ? "[DomainEmitter]" : "undefined" != typeof global && t === global ? "[Global]" : "undefined" != typeof window && t === window ? "[Window]" : "undefined" != typeof document && t === document ? "[Document]" : m(r = t) && "nativeEvent" in r && "preventDefault" in r && "stopPropagation" in r ? "[SyntheticEvent]" : "number" == typeof t && t != t ? "[NaN]" : void 0 === t ? "[undefined]" : "function" == typeof t ? "[Function: " + $(t) + "]" : t;
        var r
    }
                    ...
                    Q(t, "open", function (t) {
                        return function () {
                            ...
                            e.__sentry_xhr__ = {
                                ...
                                url: n[1]
                            }, p(i) && "POST" === e.__sentry_xhr__.method && i.match(/sentry_key/) && (e.__sentry_own_request__ = !0);
                            var o = function () {
                                if (4 === e.readyState) {
                                    try {
                            ...
                            return "onreadystatechange" in e && "function" == typeof e.onreadystatechange ? Q(e, "onreadystatechange", function (t) {
                                return function () {
                                    for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
        ...
        _t = function () {
            ...
            return t.prototype.toString = function (t) {
                ...
                if (["protocol", "user", "host", "projectId"].forEach(function (n) {
                    ...
                    }), !this.projectId.match(/^\d+$/)) throw new h("Invalid Dsn: Invalid projectId " + this.projectId);
                if ("http" !== this.protocol && "https" !== this.protocol) throw new h("Invalid Dsn: Invalid protocol " + this.protocol);
                if (this.port && isNaN(parseInt(this.port, 10))) throw new h("Invalid Dsn: Invalid port " + this.port)
            }, t
        }(),
        Dt = function () {
            function t() {
            ...
            return t.prototype.addScopeListener = function (t) {
                ...
                return this.A && Object.keys(this.A).length && (t.extra = e({}, this.A, t.extra)), this.M && Object.keys(this.M).length && (t.tags = e({}, this.M, t.tags)), this.C && Object.keys(this.C).length && (t.user = e({}, this.C, t.user)), this.q && Object.keys(this.q).length && (t.contexts = e({}, this.q, t.contexts)), this.F && (t.level = this.F), this.P && (t.transaction = this.P), this.X && (t.contexts = e({
                    trace: this.X.getTraceContext()
                }, t.contexts)), this.W(t), t.breadcrumbs = u(t.breadcrumbs || [], this.N), t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0, this.L(u(Rt(), this.I), t, n)
            }, t
        }();
    ...
    var Nt = 3,
        Ct = function () {
            function t(t, n, r) {
                void 0 === n && (n = new Dt), void 0 === r && (r = Nt), this.$ = r, this.B = [], this.B.push({
                    client: t,
                    scope: n
                })
            }
    ...
    var yn = function () {
        ...
        bn = function (n) {
            ...
            return r(e, n), e.prototype.sendEvent = function (n) {
                ...
                return void 0 !== this.options.fetchParameters && Object.assign(i, this.options.fetchParameters), void 0 !== this.options.headers && (i.headers = this.options.headers), this.S.add(new ot(function (n, o) {
    ...
    var Fn = e({}, Ln, Zt, Mn);
    return t.BrowserClient = qn, t.Hub = Ct, t.Integrations = Fn, t.SDK_NAME = An, t.SDK_VERSION = "5.17.0", t.Scope = Dt, t.Transports = gn, t.addBreadcrumb = function (t) {
        Ft("addBreadcrumb", t)

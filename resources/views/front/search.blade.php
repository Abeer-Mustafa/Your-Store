...
@section('content')
  <ul class="breadcrumb">
    ...
    <li><a href="{{ url('/search') }}">{{ __('home.Search Results') }}</a></li>
  </ul>
  <h1 class="title page-title"><span>{{ __('home.Search') }} - {{$input}}</span></h1>
          ...
          <div class="products-filter">
            ...
            <div class="select-group">
              ...
              <div class="input-group input-group-sm sort-by">
                ...
                <select onchange="sortFilter(this, '/updateEveryThingSearch')" class="input-sort-cat form-control" id="SortItems" name="SortItems">
              ...
              <div class="input-group input-group-sm per-page">
                ...
                <select onchange="limitFilter(this, '/updateEveryThingSearch')" class="input-limit-cat form-control" id="NumItems" name="NumItems">

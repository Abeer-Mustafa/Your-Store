...
@section('TitleImage')
{{ URL::to('/storage') }}/images/brands/{{$brand->image}}
@endsection
...
@section('content')
  <ul class="breadcrumb">
    ...
    <li><a href="{{ url('/brands') }}">{{ __('home.Brands') }}</a></li>
    <li><a href="{{ url('/brand').'/'.$brand->id }}">{{$brand->name}}</a></li>
  </ul>

  <h1 class="title page-title"><span>{{$brand->name}}</span></h1>
          ...
          <div class="products-filter">
            ...
            <div class="select-group">
              ...
              <div class="input-group input-group-sm sort-by">
                ...
                <select onchange="sortFilter(this, '/updateEveryThingBrand')" class="input-sort-cat form-control" id="SortItems" name="SortItems">
              ...
              <div class="input-group input-group-sm per-page">
                ...
                <select onchange="limitFilter(this, '/updateEveryThingBrand')" class="input-limit-cat form-control" id="NumItems" name="NumItems">
